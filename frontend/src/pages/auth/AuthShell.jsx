    ...
    <div className="flex min-h-screen bg-canvas">
      ...
      <div className="relative hidden w-1/2 flex-col justify-between overflow-hidden bg-brand-700 p-12 text-white lg:flex">
        ...
        <div className="relative flex items-center gap-2.5">
          ...
          <span className="font-display text-lg font-bold">DealFlow AI CRM</span>
        </div>

        <div className="relative">
          <h2 className="font-display text-4xl font-bold leading-tight">
            Run your sales pipeline with DealFlow AI CRM.
          </h2>
          <p className="mt-4 max-w-md text-white/70">
            DealFlow AI CRM brings leads, contacts and follow-ups into one focused
            workspace, with AI summaries, email drafts and sales insights on top.
          </p>
        ...
        <p className="relative text-xs text-white/50">
          © {new Date().getFullYear()} DealFlow AI CRM. All rights reserved.
        </p>
      </div>
